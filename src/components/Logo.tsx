...
export default function Logo({ variant = 'full', className = '', theme = 'dark' }: LogoProps) {
  ...
  // Variante compact — usa a imagem real com altura fixa para o navbar
  return (
    <div className={`relative inline-flex items-center ${className}`}>
      <img
        ...
        draggable="false"
      />
      <span className="absolute top-0 right-0 w-2 h-2 bg-[#22C55E] rounded-full border border-slate-950 animate-pulse" />
    </div>
  );
}
